    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 via-white to-white text-gray-800">
      ...
      <header className="px-6 py-4 bg-green-700 text-white shadow-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold">منصة النموذج</h1>
          </div>
          <nav className="space-x-4">
            <Link href="/dashboard" className="hover:underline">لوحة التحكم</Link>
            <Link href="/risk" className="hover:underline">إدارة المخاطر</Link>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12 text-center">
        ...
        <div className="flex justify-center gap-6 mb-12">
          <Link href="/dashboard" className="bg-green-600 text-white px-6 py-3 rounded-full font-medium shadow hover:bg-green-700">ابدأ الآن</Link>
          <Link href="/risk" className="border border-green-600 text-green-700 px-6 py-3 rounded-full font-medium hover:bg-green-50">Explore إدارة المخاطر</Link>
        </div>
